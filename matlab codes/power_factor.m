...
t   = out.Ia_pcc1.time(:);
ia  = out.Ia_pcc1.signals.values(:);
ib  = out.Ib_pcc1.signals.values(:);
ic  = out.Ic_pcc1.signals.values(:);

vab = out.Vab_pcc1.signals.values(:);
vbc = out.Vbc_pcc1.signals.values(:);
vca = out.Vca_pcc1.signals.values(:);
